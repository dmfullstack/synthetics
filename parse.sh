...
echo `date +"%Y%m%d %T"` >> /root/malay/cronjobs/parse.lst
$JAVA_HOME/bin/java parse >>  /root/malay/cronjobs/parse.lst
echo '*********************' >> /root/malay/cronjobs/parse.lst
echo "$JAVA_HOME/bin/java  /root/malay/cronjobs/parse"
ls -ltr
